...
# Installing the launchd agent from inside the app is gone: it was a second,
# half-lit path to something macos/install-service.sh already does properly,
# and it restarted the server out from under you to do it. The script stays,
# and the update dialog names it.
